	...
	<div id="mypage_main_wrap">
		...
		<div style="background-color: #71736e; padding: 1%;">
			...
			<div class="mypage_passwordtap_wrap">
				...
				<div class="mypage_password_style_wrap" style="margin: -3%;" id="check1_current_password"></div>
			</div>
			...
			<div class="mypage_passwordtap_wrap">
				...
				<div class="mypage_password_style_wrap check_result_view" style="margin: -3%;" id="check2_new_password">
				</div>
			</div>
			...
			<div class="mypage_passwordtap_wrap">
				<div class="mypage_password_style_wrap" style="margin: -3%;">
					<input type="password" placeholder="新しいパスワードをもう一同入力してください。" style="width: 100%"
							id="repeatNewPassword">
				</div>
				<div class="mypage_password_style_wrap" style="margin: -3%;" id="check3_repeat_new_password"></div>
			</div>

		</div>
	</div>
	<button class="ui primary button" style="margin: 3%;" id="updateToNewPassword" value="パスワードを更新します。">
		パスワードを更新します。
	</button>
</div>
	...
	$(function () {
		...
		$("#updateToNewPassword").on('click', function () {
			...
			if (checkFlag1_inputCurrentPassword == 1 && checkFlag2_inputNewPassword == 1 && checkFlag3_repeatNewPassword == 1) {
				...
				$.ajax({
					type: "POST",
					url: "member/updateToNewPassword",
					data: {
