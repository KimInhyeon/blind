...
<div id="mypage_wrap">
	...
	<div id="mypage_main_wrap">
		<div id="mypage_main_user_profile"> <%-- 메인1. 유저 프로필(닉네임,메일,근무기업) --%>
			...
			<div id="mypage_main_Explanation" style="float: right; text-align: center;">
				<%-- 일반회원은 인증이 필요하다는 안내페이지로 대체. --%>
				<div style="background-color: #444444; width: 95%;  display: inline-block;">
					<%--지정컬러로 바탕을 칠하기 위한 div영역설정 --%>
					<div style=" width: 65%; display: inline-block; margin-top: 5%;margin-bottom: 5%;">
						<%-- 텍스트들을 배치하기 위한 div --%>

						<div style="margin-left: 13%; margin-top: 10%; vertical-align: bottom;">
							<div style="float: left; vertical-align: bottom; margin-top: 5%;">
								<i class="lock icon"
										style="float: left; font-size: 2.5em; position: static; color: #ffffff;"></i>
							</div>
						...
						<button class="ui primary button" style="margin: 5%;"
								onclick="location.href='member/certification';">
							正會員認証を始める
						</button>
					</div>
				</div>
			...
			<div id="mypage_button_warp" style="margin-top: 70%;"> <%-- main구성 : 2.각종 버튼탭(버튼모음) --%>
				<div id="mypage_button_update_certification_and_income">
					<div class="mypage_buttontap_name" style="color: #ffffff;">アカウントの情報変更</div>
					<div class="mypage_buttontap_wrap">
						...
						<div class="mypage_button_style_wrap" onclick="location.href='member/annualIncome';">
							<div class="mypage_button_style_button_name">
								私の年俸ランキング
							</div>
							<div class="mypage_button_style_button_icon">
				...
				<div id="mypage_buttontap_invite_and_weblogin"> <%-- 버튼탭2. 타인초대 및 웹로그인 --%>
					<div class="mypage_buttontap_name" style="color: #ffffff;">招待、Webログイン</div>
					<div class="mypage_buttontap_wrap">
						<div class="mypage_button_style_wrap" onclick="location.href='member/invite';">
							<div class="mypage_button_style_button_name">招待する</div>
							<div class="mypage_button_style_button_icon">
								<i class="chevron right icon"></i>
							</div>
						</div>
				...
				<div id="mypage_buttontap_writedpost_and_bookmark"> <%-- 버튼탭3. 로그인한 회원이 작성한 포스트/기업리뷰, 즐겨핯기한 포스트 리스트출력--%>
					...
					<div class="mypage_buttontap_wrap">
						<div class="mypage_button_style_wrap" onclick="location.href='member/post';">
							<div class="mypage_button_style_button_name">私が書いたポスト</div>
							<div class="mypage_button_style_button_icon">
								<i class="chevron right icon"></i>
							</div>
						</div>
						...
						<div class="mypage_button_style_wrap" onclick="location.href='bookmark';">
							<div class="mypage_button_style_button_name">ブックマーク</div>
							<div class="mypage_button_style_button_icon">
								<i class="chevron right icon"></i>
							</div>
						</div>

						<div class="mypage_button_style_wrap" onclick="location.href='member/review';">
							<div class="mypage_button_style_button_name">企業レビュー</div>
							<div class="mypage_button_style_button_icon">
								<i class="chevron right icon"></i>
							</div>
						</div>
				...
				<div id="mypage_buttontap_service_center"> <%-- 버튼탭4. 고객센터--%>
					...
					<div class="mypage_buttontap_wrap">
						<div class="mypage_button_style_wrap" id="intro_popup_service_center">
							<div class="mypage_button_style_button_name">お問い合わせ・バグの報告</div>
							<div class="mypage_button_style_button_icon">
								<i class="chevron right icon"></i>
							</div>
						</div>
