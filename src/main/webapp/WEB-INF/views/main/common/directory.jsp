...
<article class="ui container">
	...
	<c:forEach var="company" items="${companyList}">
		<a class="column item" href="company/introduction/${company.companyId}">${company.companyName}　紹介</a>
		<a class="column item" href="company/review/${company.companyId}">${company.companyName}　レビュー</a>
		<a class="column item" href="company/post/${company.companyId}">${company.companyName}　掲示板</a>
		<a class="column item" href="company/annualIncome/${company.companyId}">${company.companyName}　年収</a>
		<a class="column item">${company.companyName}　採用</a>
		<a class="column item" href="company/news/${company.companyId}">${company.companyName}　ニュース</a>
	</c:forEach>
	</section>
		...
		<c:choose>
			<c:when test="${navi.startPage gt navi.pagination}">
				<div class="ui pagination menu">
					<a class="item" href="javascript:getDirectoryListByPage(${navi.startPage - navi.pagination})">
						前へ
					</a>
				</div>
			</c:when>
