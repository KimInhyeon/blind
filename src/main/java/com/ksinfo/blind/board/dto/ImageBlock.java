...
public final class ImageBlock extends PostBlock {
	public static final class ImageData extends Data {
		...
		public ImageData(
			@JsonProperty("url") String url, @JsonProperty("caption") String caption,
			@JsonProperty("withBorder") boolean withBorder, @JsonProperty("withBackground") boolean withBackground,
