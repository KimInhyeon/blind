...
public class CompanyAnnualIncomeForAndroidVO {
    ...
    public CompanyAnnualIncomeForAndroidVO(int minAnnualIncome, int avgAnnualIncome, int maxAnnualIncome,
                                           int userAnnualIncome, int countOfParticipant, float userRank ) {
