...
%>  
		<div class="ui stackable menu"  style="font-weight: bold; font-size: 1.4em; line-height: 1.0em;  margin-top:-5px">
		  <div class="item" style="width: 200px;height: 75px">
            	  <a href="${pageContext.request.contextPath}/main"><img src="${pageContext.request.contextPath}/resources/images/logo.png" style="margin-left:-25px"/></a>
          </div>
                <a  class="browse item" href="javascript:location.href='${pageContext.request.contextPath}/topicMain'" style="color: black">トピック</a>
			    <a  class="browse item" href="javascript:location.href='${pageContext.request.contextPath}/companyMain'" style="color: black">企業情報</a>
		<!--  Message Area -->
