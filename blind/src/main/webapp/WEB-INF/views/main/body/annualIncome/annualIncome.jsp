...
<div class="ui top attached tabular menu" style="font-size:1.2rem;">
  ...
  <div class="item" onclick="location.href='companyNews/${companyProfile[0].companyId}'" style="display:flex; justify-content:center; width:15%; cursor:pointer;">ニュース</div>
