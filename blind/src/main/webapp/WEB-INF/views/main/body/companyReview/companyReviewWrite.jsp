                    ...
                    success: function(result){
                        ...
                        if(companyName != ""){
                            ...
                            $.each(result, function (key, value) {
                                ...
                                resultHtml = resultHtml + '<div class="item" style="background-color:white; display:flex; border-radius:50px;"  onclick="companyNameClick(\''+value.companyId+'★'+value.companyName+'\')"><img class="ui left floated image" style="margin:10px;" src="${pageContext.request.contextPath}/resources/images/company/'+value.companyId+'.png" width="70" height="70"><div class="content"><div class="header" style="padding-top:25px;">'+value.companyName+'</div><div style="padding-top:5px;"><i class="star icon" style="color:yellow;"></i>'+value.companyName+'</div></div></div>'
                                $('#selectList').attr("style","position:absolute; top:50px; width:100%; box-shadow: 0px 0px 15px #999999;");
            ...
            <div style="padding:40px;">
                <form class="ui form" id="reviewForm" name= "reviewForm" method="post" action="companyReviewWrite" onsubmit="return check();">
                    <div>
                        ...
                        <img class = "ui tiny left floated image" src ="${pageContext.request.contextPath}/resources/images/company/${companyId }.png" Id="companyReviewImg"alt="" width="90" height="90" ></img>
                        <h4>会社名</h4>
                        <div class="ui fluid input">
                            <input type="text" class="box1" placeholder="会社名前で検索してください" id="companyName" name="companyName"><div id="selectList" style="position:absolute; top:50px; left:5px; width:100%; border-radius:50px;"></div></input>
