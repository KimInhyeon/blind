				...
				<td>
					<div class="ui input">
						<input type="text" class="form-control" name="username" id="username" maxlength="50"
							   placeholder="E-MAIL" onkeydown="loginWithEnter()">
					</div>
				</td>
				<td rowspan="3">
					<button class="ui blue button" style=height:80px; id="loginBtn" onclick="submitForm()"
							type="button">ログイン
					</button>
				</td>
			</tr>
				...
				<td>
					<div class="ui input">
						<input type="password" class="form-control" name="password" id="password" maxlength="20"
							   placeholder="パスワード" onkeydown="loginWithEnter()">
					</div>
				</td>
			</tr>
		</table>
