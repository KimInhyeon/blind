				...
				<td>
					<div class="ui input">
						<input type="email" class="form-control" name="username" id="username" maxlength="50"
							   placeholder="E-MAIL" onkeydown="regWithEnter()">
					</div>
				</td>
				<td rowspan="3">
					<button class="ui blue button" style=height:80px; id="regBtn" onclick="submitForm()" type="button">
						登録
					</button>
				</td>
			</tr>
				...
				<td>
					<div class="ui input">
						<input type="password" class="form-control" name="password" id="password" maxlength="20"
							   placeholder="パスワード" onkeydown="regWithEnter()">
					</div>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div class="ui input">
						<input type="text" class="form-control" name="nickName" id="nickName" maxlength="20"
							   placeholder="ニックネーム" onkeydown="regWithEnter()">
					</div>
				</td>
			</tr>
		</table>
