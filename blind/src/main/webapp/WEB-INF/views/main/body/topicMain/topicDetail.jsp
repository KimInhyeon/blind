...
<body>
	<div class="ui text container">
		...
		<div class="column">
			...
			<fmt:formatDate value="${postDetailDto.postCreateDate}" pattern="MM-dd" />
	...
	<div class="ui text container">
		...
		<br><br>
		<div class="column">
			<i class="thumbs up outline icon"></i>0 &nbsp;&nbsp;&nbsp;
			<i class="comment outline icon"></i>
			<input type="text" value="${resultCount}" id="resultCount" style="border-width: 0px;"><br>
		</div>
	</div>
	<br>
	<div class="ui container divider"></div>
