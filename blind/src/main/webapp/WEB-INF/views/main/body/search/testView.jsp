...
<body>
	...
	<div class="swiper-container">
		<div class="swiper-wrapper">
			<div class="swiper-slide">
				<a
					href="javascript:location.href='${pageContext.request.contextPath}/searchBoardName?searchKeyword=6'">${topicMainMessage[0].boardTopicName }</a>&nbsp;&nbsp;&nbsp;
				<a
				...
				<div class="row">
					...
					<c:forEach items="${topicMainMessage }" var="topicMainMessage">
						...
						<div class="eight wide column"
							...
							<!-- 두개의 쿼리문을 조인해서 사용하자 -->
							<a href=""><span>${topicMainMessage.boardTopicName }</span></a> <a
								href=""><span style="font-size: 130%; font-weight: 700;">title</span></a>
							<div class="ui grid">
								<div class="thirteen wide column">
									<a href=""><p>contents</p></a>
								</div>
								<div class="three wide column">
									<img class="ui tiny right floated image"
										src="bookmarkimage.png">

								</div>
								<a href=""><span>userid・userid</span></a>
								<div class="ui left floated horizontal list">
									<a class="item" href="http://naver.com"><i class="eye icon"></i><span
										style="padding: 0 5px;">1234</span></a> <a class="item"
										href="http://naver.com"><i class="thumbs up outline icon"></i><span
								...
								<div class="ui right floated horizontal list">
									<a class="item" href="http://naver.com"><span
										style="padding-left: 5px; color: gray;">05.25</span></a> <a
										class="item" href="#"><i class="bookmark outline icon"></i><span
						...
						<div class="eight wide column"
							style="border-color: #d4d4d5; border-width: thin !important; border-style: inset;">
							<a href=""><span>会社生活</span></a> <a href=""><span
								style="font-size: 130%; font-weight: 700;">title</span></a>
							<p>contents</p>
							<a href=""><span>資生堂・J******</span></a>
							<div class="ui left floated horizontal list">
								<a class="item" href="http://naver.com"><i class="eye icon"></i><span
									style="padding: 0 5px;">1234</span></a> <a class="item"
									href="http://naver.com"><i class="thumbs up outline icon"></i><span
	...
	<div class="ui fitted divider" style="border-width: thin;">
		<!--fit 되는 얇은 선-->
	</div>
	<div class="bookmarkcontent">
		<div class="ui internally celled grid">
			<div class="row">
				<!--1행-->
				<div class="eight wide column">
					<!--           <a href=""><span>${topicMainMessage[0].boardTopicName }</span></a> -->
					<a href=""><span>${topicMainMessage[0].boardTopicName }</span></a>
					<a href=""><span style="font-size: 130%; font-weight: 700;">title</span></a>
					<div class="ui grid">
						<div class="thirteen wide column">
		...
		<div class="ui internally celled grid">
			<div class="row">
				...
				<div class="eight wide column">
					<a href=""><span>会社生活</span></a> <a href=""><span
						style="font-size: 130%; font-weight: 700;">title</span></a>
					<p>${searchResultPosts.postContents }
						<a href=""><span>資生堂・J******</span></a>
					<div class="ui left floated horizontal list">
						<a class="item" href="http://naver.com"><i class="eye icon"></i><span
							style="padding: 0 5px;">1234</span></a> <a class="item"
