...
<title>KSINFOSYS_BLIND PROTOTYPE</title>
	...
	.mypage_header{
		font-size: 2.5em;
		margin:2%; padding:4%; /*내부의 요소들을 정렬위한 여백 설정.*/
		margin-left:-4%; margin-right:-4%; margin-top:-4%; /*배경색을 전체 적용하기 위한 설정.*/
	...
	#intro_user_function{
		margin-left: auto; margin-right: auto;  /*테이블 자체 가운데 정렬*/
...
<!-- 인증페이지 -->
	<div id="mypage_wrap" >
		...
		<div>
			<button class="ui primary button" style="margin-top:5%;" 
				    id="sendEmailCertification">
			 	ネクスト
			</button>
		</div>
