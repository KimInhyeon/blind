        ...
        <c:forEach var="topicbest" items="${topicBestList }">  
            <div class="topicbest">
                <div class="ui right floated horizontal list">
                    <i class="thumbs up outline icon item" style="position:absolute; right:28.5%;"></i><span class="item" style="position:absolute; right:27%;">${topicbest.recommendCount }</span>
                    <i class="comment outline icon item" style="position:absolute; right:25%;"></i><span class="item">${topicbest.replyCount }</span>   
                </div>
