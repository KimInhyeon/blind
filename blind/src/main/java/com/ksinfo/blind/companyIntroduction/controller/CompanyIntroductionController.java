...
public class CompanyIntroductionController {
	...
	public ModelAndView CompanyShowReview(HttpServletRequest req, Long companyId) throws Exception {
		...
		List<CompanyJoinDto> companyReviewList = companyIntroductionService.companyReviewList(companyId);
	...
	public List<CompanyJoinDto> helpCountup(Long companyId,Long companyReviewId, @AuthenticationPrincipal Account account){
